...
export default function CrearDueño() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const response = await axios.post('http://127.0.0.1:8000/dueño/dueños_create', formData);
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold text-center mb-8">Crear Nuevo Dueño</h1>
